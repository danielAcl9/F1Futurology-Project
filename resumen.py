...
dfF = pd.DataFrame(columns=['NNUM', 'DRIVER', 'PRED-POS', 'CIRCUIT'])

with open('rfr_model.pkl', 'rb') as archivo:
    rfr_model = pickle.load(archivo)

with open('ridge_model.pkl', 'rb') as archivo:
    ridge_model = pickle.load(archivo)

with open('lasso_model.pkl', 'rb') as archivo:
    lasso_model = pickle.load(archivo)

with open('knn_model.pkl', 'rb') as archivo:
    knn_model = pickle.load(archivo) 

with open('xgb_model.pkl', 'rb') as archivo:
...
for i in pilotos:
    ...
    dfF.loc[len(dfF.index)] = [i, driverName, res, circuitName]
